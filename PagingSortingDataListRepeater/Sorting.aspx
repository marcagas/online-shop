<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Sorting.aspx.cs" Inherits="PagingSortingDataListRepeater_Sorting" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <p>
        ...
        <asp:ObjectDataSource ID="ProductsDataSource" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="GetProducts" TypeName="ProductsBLL" OnSelecting="ProductsDataSource_Selecting"></asp:ObjectDataSource>
    </p>
</asp:Content>
