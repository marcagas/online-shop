<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="OptimisticConcurrency.aspx.cs" Inherits="EditDeleteDataList_OptimisticConcurrency" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <p>
        ...
        <asp:DataList ID="Products" runat="server" DataKeyField="ProductID" DataSourceID="ProductsDataSource" OnCancelCommand="Products_CancelCommand" OnDeleteCommand="Products_DeleteCommand" OnEditCommand="Products_EditCommand" OnUpdateCommand="Products_UpdateCommand" OnItemDataBound="Products_ItemDataBound">
            <ItemTemplate>                
