<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="CustomizedUI.aspx.cs" Inherits="EditDeleteDataList_CustomizedUI" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <h2>
        A Customized Editing Interface</h2>
    <p>
        <asp:DataList ID="Products" runat="server" DataKeyField="ProductID" DataSourceID="ProductsDataSource" OnCancelCommand="Products_CancelCommand" OnEditCommand="Products_EditCommand" OnUpdateCommand="Products_UpdateCommand">
            <ItemTemplate>
