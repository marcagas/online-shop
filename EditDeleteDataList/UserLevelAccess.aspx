<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="UserLevelAccess.aspx.cs" Inherits="EditDeleteDataList_UserLevelAccess" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <p>
        ...
        <asp:DropDownList ID="LoggedOnAs" runat="server" AppendDataBoundItems="True" DataSourceID="LoggedOnAsDataSource"
            DataTextField="LastName" DataValueField="EmployeeID" AutoPostBack="True" OnSelectedIndexChanged="LoggedOnAs_SelectedIndexChanged">
    ...
    <p>
        <asp:DataList ID="Employees" runat="server" DataKeyField="EmployeeID" DataSourceID="EmployeesDataSource" OnCancelCommand="Employees_CancelCommand" OnEditCommand="Employees_EditCommand" OnUpdateCommand="Employees_UpdateCommand" OnItemDataBound="Employees_ItemDataBound">
            <ItemTemplate>
                <h4>
