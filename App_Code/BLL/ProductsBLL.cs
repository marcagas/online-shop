...
public class ProductsBLL
{
    ...
    #region Default Paging-Related Methods (needed for the DataList and Repeater)
    [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, false)]
    ...
    [System.ComponentModel.DataObjectMethodAttribute(System.ComponentModel.DataObjectMethodType.Select, false)]
    public PagedDataSource GetProductsSortedAsPagedDataSource(string sortExpression, int pageIndex, int pageSize)
    {
        // Get ALL of the products
        Northwind.ProductsDataTable products = GetProducts();
