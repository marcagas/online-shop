<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="FilterByDropDownList.aspx.cs" Inherits="DataListRepeaterFiltering_FilterByDropDownList" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <h2>
        Sort Products by Category</h2>
    <p>
        Select a category:
