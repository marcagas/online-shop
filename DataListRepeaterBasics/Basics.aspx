<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Basics.aspx.cs" Inherits="DataListRepeaterBasics_Basics" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <p>
        ...
        <asp:Button ID="Button1" runat="server" 
            PostBackUrl="~/Reports/ReportProduct.aspx" Text="Generate Report" 
            Width="163px" />
