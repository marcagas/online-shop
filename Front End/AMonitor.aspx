<%@ Page Title="" Language="C#" MasterPageFile="~/FrontMaster.master" AutoEventWireup="true" CodeFile="AMonitor.aspx.cs" Inherits="Front_End_AMonitor" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="GridView1" DefaultValue="7" Name="categoryID" 
...
<asp:GridView ID="GridView2" runat="server" AllowPaging="True" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="GridView2" DefaultValue="Monitor" 
