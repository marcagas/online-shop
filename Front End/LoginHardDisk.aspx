<%@ Page Title="" Language="C#" MasterPageFile="~/FrontMaster.master" AutoEventWireup="true" CodeFile="LoginHardDisk.aspx.cs" Inherits="Front_End_LoginHardDisk" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Text="Hard Disk Drive"></asp:Label>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [ProductName], [CategoryID], [UnitPrice], [UnitsInStock] FROM [Products] WHERE ([CategoryID] = @CategoryID) ORDER BY [CategoryID], [ProductName], [UnitPrice]">
        <SelectParameters>
            <asp:ControlParameter ControlID="DataList1" DefaultValue="2" Name="CategoryID" 
  ...
  <br />
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="GridView4" DefaultValue="Hard Disk Drive" 
