<%@ Page Title="" Language="C#" MasterPageFile="~/FrontMaster.master" AutoEventWireup="true" CodeFile="Antivirus.aspx.cs" Inherits="Front_End_LogOut_Antivirus" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        DataSourceID="ObjectDataSource1" PageSize="5" Width="868px">
        <Columns>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="GridView1" DefaultValue="1" Name="categoryID" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="GridView2" DefaultValue="Antivirus" 
