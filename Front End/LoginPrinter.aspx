<%@ Page Title="" Language="C#" MasterPageFile="~/FrontMaster.master" AutoEventWireup="true" CodeFile="LoginPrinter.aspx.cs" Inherits="Front_End_LoginPrinter" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:DataList ID="DataList1" runat="server" BackColor="#CCCCCC" 
        ...
        RepeatDirection="Horizontal" Width="875px" DataKeyField="CategoryID">
        ...
        <ItemTemplate>
            ...
            <asp:ImageButton ID="ImageButton1" runat="server" 
                ImageUrl="~/Front End/img/detail.jpg" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [ProductName], [CategoryID], [UnitPrice] FROM [Products] WHERE ([CategoryID] = @CategoryID)">
        <SelectParameters>
            <asp:ControlParameter ControlID="DataList1" DefaultValue="25" Name="CategoryID" 
  ...
  <br />
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="GridView4" DefaultValue="Printer" 
