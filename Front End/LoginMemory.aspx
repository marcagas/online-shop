<%@ Page Title="" Language="C#" MasterPageFile="~/FrontMaster.master" AutoEventWireup="true" CodeFile="LoginMemory.aspx.cs" Inherits="Front_End_LoginMemory" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="DataList1" DefaultValue="5" Name="CategoryID" 
 ...
 <br />
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="GridView4" DefaultValue="Memory" 
