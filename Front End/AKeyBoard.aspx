<%@ Page Title="" Language="C#" MasterPageFile="~/FrontMaster.master" AutoEventWireup="true" CodeFile="AKeyBoard.aspx.cs" Inherits="Front_End_AKeyBoard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Text="KeyBoard"></asp:Label>
    <br />
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        AutoGenerateColumns="False" DataKeyNames="ProductID" 
        DataSourceID="ObjectDataSource1" PageSize="5" Width="872px">
        <Columns>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="GridView1" DefaultValue="4" Name="categoryID" 
...
<asp:GridView ID="GridView2" runat="server" AllowPaging="True" 
        ...
        <asp:TemplateField HeaderText="Image">
                    <ItemTemplate>
                 <asp:Image ID="img" runat="server" Height= '100px' Width='150px' ImageUrl='<%# "Handler.ashx?PicID=" +Eval("PicID") %>'></asp:Image>
                     </ItemTemplate>
                </asp:TemplateField>
        </Columns>
    </asp:GridView>
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="GridView2" DefaultValue="Keyboard" 
