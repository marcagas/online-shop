<%@ Page Title="" Language="C#" MasterPageFile="~/FrontMaster.master" AutoEventWireup="true" CodeFile="AMemory.aspx.cs" Inherits="Front_End_AMemory" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Text="Memory"></asp:Label>
    <br />
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        AutoGenerateColumns="False" DataKeyNames="ProductID" 
        DataSourceID="ObjectDataSource1" PageSize="5" Width="871px">
        <Columns>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="GridView1" DefaultValue="5" Name="categoryID" 
...
<asp:GridView ID="GridView2" runat="server" AllowPaging="True" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="GridView2" DefaultValue="Memory" 
