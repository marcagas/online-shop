<%@ Page Title="" Language="C#" MasterPageFile="~/FrontMaster.master" AutoEventWireup="true" CodeFile="AHardDisk.aspx.cs" Inherits="Front_End_AHardDisk" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Text="Hard Disk"></asp:Label>
    <br />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="GridView1" DefaultValue="2" Name="categoryID" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="GridView2" DefaultValue="Hard Disk Drive" 
