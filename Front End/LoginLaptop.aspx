<%@ Page Title="" Language="C#" MasterPageFile="~/FrontMaster.master" AutoEventWireup="true" CodeFile="LoginLaptop.aspx.cs" Inherits="Front_End_LoginLaptop" %>
...
<br />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="DataList1" DefaultValue="8" Name="CategoryID" 
 ...
 <br />
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="GridView4" DefaultValue="Laptop" 
