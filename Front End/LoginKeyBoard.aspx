<%@ Page Title="" Language="C#" MasterPageFile="~/FrontMaster.master" AutoEventWireup="true" CodeFile="LoginKeyBoard.aspx.cs" Inherits="Front_End_LoginKeyBoard" %>
...
<asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Front End/img/detail.jpg" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="DataList1" DefaultValue="4" Name="CategoryID" 
 ...
 <br />
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ...
        <SelectParameters>
            <asp:ControlParameter ControlID="GridView4" DefaultValue="Keyboard" 
