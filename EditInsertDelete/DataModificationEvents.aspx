<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DataModificationEvents.aspx.cs" Inherits="EditInsertDelete_DataModificationEvents" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <h2>
        Update and Insert of Products</h2>
    <p>
     ...
     <p>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetProducts"
            TypeName="ProductsBLL" UpdateMethod="UpdateProduct" InsertMethod="AddProduct" OnInserting="ObjectDataSource1_Inserting">
            <UpdateParameters>
