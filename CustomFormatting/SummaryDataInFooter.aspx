<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="SummaryDataInFooter.aspx.cs" Inherits="CustomFormatting_SummaryDataInFooter" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <p>
        ...
        <asp:GridView ID="ProductsInCategory" runat="server" AutoGenerateColumns="False"
            DataKeyNames="ProductID" DataSourceID="ProductsInCategoryDataSource" OnRowDataBound="ProductsInCategory_RowDataBound" ShowFooter="True" EnableViewState="False">
            <Columns>
