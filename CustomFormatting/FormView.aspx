<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="FormView.aspx.cs" Inherits="CustomFormatting_FormView" Title="Untitled Page" %>
                ...
                <table border="0">
                    ...
                    <tr>
                        ...
                        <td class="ProductPropertyValue">
                            <asp:CheckBox runat="server" Enabled="false" Checked='<%# Eval("Discontinued") %>' />
                        </td>
                    </tr>
                </table>
                <hr />
